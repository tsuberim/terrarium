...
(module $strategy_scavenger.wasm
  ...
  (import "terrarium" "signal_broadcast" (func $_ZN15strategy_hunter4host16signal_broadcast17h575c2111c62c1639E (;6;) (type 4)))
  (import "terrarium" "eat" (func $_ZN15strategy_hunter4host3eat17h998f6d8089554deaE (;7;) (type 4)))
  ...
  (func $_ZN15strategy_hunter6wander17h043ae9e92772ba5aE (;14;) (type 2)
  ...
  (func $_ZN15strategy_hunter4tick17hf6c31264d052907dE (;16;) (type 7) (param i32 i32)
...
(module $strategy_prey.wasm
  ...
  (func $_RNvCsj4CZ6flxxfE_7___rustc17rust_begin_unwind (;8;) (type 6) (param i32)
    call $_ZN15strategy_hunter4host5sleep17h937936acb95e37b2E
    loop ;; label = @1
      br 0 (;@1;)
    end
  )
  (func $_ZN15strategy_hunter11maybe_clone17h2c98f5d73388d033E (;9;) (type 3) (result i32)
    (local i32 i32 i32)
    i32.const 0
    local.set 0
    block ;; label = @1
  ...
  (func $_ZN15strategy_hunter9prey_tick17h74a7446dc3f74c04E (;10;) (type 2)
    (local i32 i32)
    block ;; label = @1
      call $_ZN15strategy_hunter11maybe_clone17h2c98f5d73388d033E
      br_if 0 (;@1;)
  ...
  (func $_ZN4core9panicking18panic_bounds_check17hf4028f296c44236fE (;11;) (type 7) (param i32 i32 i32)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 48
    i32.sub
  ...
  (func $_ZN4core9panicking9panic_fmt17h808dbde205a89691E (;12;) (type 8) (param i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $_ZN4core3str5count14do_count_chars17haa2c4f188ad8cef2E (;13;) (type 0) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    block ;; label = @1
      block ;; label = @2
        local.get 1
  ...
  (func $_ZN4core3fmt3num3imp52_$LT$impl$u20$core..fmt..Display$u20$for$u20$u32$GT$3fmt17hacc3ad28f4de0a4dE (;14;) (type 0) (param i32 i32) (result i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $_ZN4core3fmt9Formatter12pad_integral17hc6b3558773c79a2cE (;15;) (type 9) (param i32 i32 i32 i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i64)
    block ;; label = @1
      block ;; label = @2
        local.get 1
  ...
  (func $_ZN4core3fmt9Formatter12pad_integral12write_prefix17he51f5cf01766db4eE (;16;) (type 10) (param i32 i32 i32 i32 i32) (result i32)
    block ;; label = @1
      local.get 2
      i32.const 1114112
      i32.eq
  ...
  (func $_ZN4core3fmt3num3imp21_$LT$impl$u20$u32$GT$4_fmt17hb4e91fd13b3ed913E (;17;) (type 11) (param i32 i32 i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    local.get 1
    local.set 4
    local.get 3
...
(module $strategy_predator.wasm
  ...
  (func $_RNvCsj4CZ6flxxfE_7___rustc17rust_begin_unwind (;10;) (type 6) (param i32)
    call $_ZN15strategy_hunter4host5sleep17h937936acb95e37b2E
    loop ;; label = @1
      br 0 (;@1;)
    end
  ...
  (func $_ZN15strategy_hunter4tick17hf6c31264d052907dE (;13;) (type 7) (param i32 i32)
    (local i32 i32 i32 i32 i32)
    i32.const 0
    local.set 2
    i32.const 1
...
(module $strategy_hawk.wasm
  ...
  (import "terrarium" "sense" (func $_ZN15strategy_hunter4host5sense17hc58ae7581ba11934E (;4;) (type 1)))
  (import "terrarium" "spawn" (func $_ZN15strategy_hunter4host5spawn17h1c054dc162b77db4E (;5;) (type 0)))
  (import "terrarium" "recv" (func $_ZN15strategy_hunter4host4recv17h0668d301ceeeb97fE (;6;) (type 4)))
  (import "terrarium" "pos_x" (func $_ZN15strategy_hunter4host5pos_x17h83d553ce0faa30ccE (;7;) (type 3)))
  (import "terrarium" "pos_y" (func $_ZN15strategy_hunter4host5pos_y17h042d3565584392bdE (;8;) (type 3)))
  (table (;0;) 2 2 funcref)
  (memory (;0;) 17)
  (global $__stack_pointer (;0;) (mut i32) i32.const 1048576)
  (global (;1;) i32 i32.const 1048988)
  ...
  (elem (;0;) (i32.const 1) func $_ZN4core3fmt3num3imp52_$LT$impl$u20$core..fmt..Display$u20$for$u20$u32$GT$3fmt17hacc3ad28f4de0a4dE)
  (func $tick (;9;) (type 2)
    call $_ZN15strategy_hunter9hawk_tick17h6e18d087796e94c1E
  )
  (func $_RNvCsj4CZ6flxxfE_7___rustc17rust_begin_unwind (;10;) (type 6) (param i32)
    call $_ZN15strategy_hunter4host5sleep17h937936acb95e37b2E
    loop ;; label = @1
  ...
  (func $_ZN15strategy_hunter11maybe_clone17h2c98f5d73388d033E (;11;) (type 3) (result i32)
    (local i32 i32 i32)
    i32.const 0
    local.set 0
    block ;; label = @1
  ...
  (func $_ZN15strategy_hunter9hawk_tick17h6e18d087796e94c1E (;12;) (type 2)
    (local i32 i32 i32 i32 i32)
    block ;; label = @1
      call $_ZN15strategy_hunter11maybe_clone17h2c98f5d73388d033E
      br_if 0 (;@1;)
  ...
  (func $_ZN4core9panicking18panic_bounds_check17hf4028f296c44236fE (;13;) (type 7) (param i32 i32 i32)
    (local i32 i64)
    global.get $__stack_pointer
    i32.const 48
    i32.sub
  ...
  (func $_ZN4core9panicking9panic_fmt17h808dbde205a89691E (;14;) (type 8) (param i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
  ...
  (func $_ZN4core3str5count14do_count_chars17haa2c4f188ad8cef2E (;15;) (type 0) (param i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    block ;; label = @1
      block ;; label = @2
        local.get 1
  ...
  (func $_ZN4core3fmt3num3imp52_$LT$impl$u20$core..fmt..Display$u20$for$u20$u32$GT$3fmt17hacc3ad28f4de0a4dE (;16;) (type 0) (param i32 i32) (result i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 32
    i32.sub
  ...
  (func $_ZN4core3fmt9Formatter12pad_integral17hc6b3558773c79a2cE (;17;) (type 9) (param i32 i32 i32 i32 i32 i32) (result i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i64)
    block ;; label = @1
      block ;; label = @2
        local.get 1
  ...
  (func $_ZN4core3fmt9Formatter12pad_integral12write_prefix17he51f5cf01766db4eE (;18;) (type 10) (param i32 i32 i32 i32 i32) (result i32)
    block ;; label = @1
      local.get 2
      i32.const 1114112
      i32.eq
  ...
  (func $_ZN4core3fmt3num3imp21_$LT$impl$u20$u32$GT$4_fmt17hb4e91fd13b3ed913E (;19;) (type 11) (param i32 i32 i32 i32)
    (local i32 i32 i32 i32 i32 i32 i32 i32)
    local.get 1
    local.set 4
    local.get 3
