...
(module $strategy_scavenger.wasm
  ...
  (func $_ZN4core9panicking9panic_fmt17h808dbde205a89691E (;16;) (type 8) (param i32 i32)
    (local i32)
    global.get $__stack_pointer
    i32.const 16
    i32.sub
...
(module $strategy_prey.wasm
  ...
  (func $_RNvCsj4CZ6flxxfE_7___rustc17rust_begin_unwind (;9;) (type 6) (param i32)
    call $_ZN15strategy_hunter4host5sleep17h937936acb95e37b2E
    loop ;; label = @1
      br 0 (;@1;)
    end
  ...
  (func $_ZN15strategy_hunter9seek_food17hdc63cb46d6416604E (;11;) (type 0) (param i32 i32) (result i32)
    (local i32 i32 i64 i32 i32 i32 i64 i32 i32)
    i32.const 0
    local.set 2
    i32.const 1
